...
class AlbumPage extends Component {
  ...
  render() {
    return (
      <Col
        className="col-sm-12 col-md-9 col-lg-10 music-list"
      ...
      >
        ...
        <div className="filter ml-5"></div>
        <div className="row album-list row-cols-1 row-cols-md-2 row-cols-lg-4  align-items-start"></div>
      </Col>
    );
  }
}
